...
class ScienceWorldDataset(MultiTurnDataset):
    ...
    def _load_data(self) -> List[TaskInstance]:
        ...
        tasks = [
            ...
            {"goal": "Melt ice by heating it on the bunsen burner.", "type": "phase_change"},
            {"goal": "Evaporate water from a beaker.", "type": "phase_change"},
            {"goal": "Observe what happens when you heat ice past 100°C.", "type": "phase_change"},
            {"goal": "Create steam by boiling water on the bunsen burner.", "type": "phase_change"},
            {"goal": "Freeze water and then melt it again.", "type": "phase_change"},
            {"goal": "Turn ice into gas by heating it.", "type": "phase_change"},
            {"goal": "Cool steam back into liquid water.", "type": "phase_change"},
            {"goal": "Melt ice in a beaker and record the temperature.", "type": "phase_change"},
            {"goal": "Demonstrate all three states of water.", "type": "phase_change"},
            {"goal": "Change water from liquid to solid.", "type": "phase_change"},
            {"goal": "Heat ice until it becomes a gas.", "type": "phase_change"},
            {"goal": "Freeze water by cooling it below 0°C.", "type": "phase_change"},
            {"goal": "Boil water and observe the steam.", "type": "phase_change"},
            {"goal": "Melt a frozen substance using heat.", "type": "phase_change"},
            {"goal": "Solidify water by reducing its temperature.", "type": "phase_change"},
            {"goal": "Show that ice melts above 0°C.", "type": "phase_change"},
            {"goal": "Evaporate water by heating it past its boiling point.", "type": "phase_change"},
            # --- Measurement (15 tasks) ---
            {"goal": "Measure the temperature of the water.", "type": "measurement"},
            {"goal": "Measure the temperature of ice.", "type": "measurement"},
            {"goal": "Use the thermometer to check the water temperature.", "type": "measurement"},
            {"goal": "Record the temperature of a heated beaker.", "type": "measurement"},
            {"goal": "Measure the temperature of cooled water.", "type": "measurement"},
            {"goal": "Check if the water is above room temperature.", "type": "measurement"},
            {"goal": "Measure the temperature of ice after heating it.", "type": "measurement"},
            {"goal": "Use the thermometer on the water in the sink.", "type": "measurement"},
            {"goal": "Measure how cold the ice is.", "type": "measurement"},
            {"goal": "Record the room temperature of water.", "type": "measurement"},
            {"goal": "Measure the temperature before and after heating.", "type": "measurement"},
            {"goal": "Check the temperature of the beaker contents.", "type": "measurement"},
            {"goal": "Determine the temperature of water from the sink.", "type": "measurement"},
            {"goal": "Measure the freezing point of water.", "type": "measurement"},
            {"goal": "Use a thermometer to measure the boiling point.", "type": "measurement"},
            # --- Heating (15 tasks) ---
            {"goal": "Heat the beaker with water.", "type": "heating"},
            {"goal": "Heat ice until it melts.", "type": "heating"},
            {"goal": "Warm water using the bunsen burner.", "type": "heating"},
            {"goal": "Heat a substance and observe the change.", "type": "heating"},
            {"goal": "Raise the temperature of water by 50 degrees.", "type": "heating"},
            {"goal": "Heat the water in the beaker to boiling.", "type": "heating"},
            {"goal": "Use the bunsen burner to heat the ice.", "type": "heating"},
            {"goal": "Heat water and measure the new temperature.", "type": "heating"},
            {"goal": "Apply heat to ice and record what happens.", "type": "heating"},
            {"goal": "Heat the water until it starts to evaporate.", "type": "heating"},
            {"goal": "Warm the beaker contents on the bunsen burner.", "type": "heating"},
            {"goal": "Heat ice in a beaker until it changes state.", "type": "heating"},
            {"goal": "Bring water to a high temperature.", "type": "heating"},
            {"goal": "Heat the water from room temperature.", "type": "heating"},
            {"goal": "Apply heat to a frozen sample.", "type": "heating"},
            # --- Cooling (15 tasks) ---
            {"goal": "Cool the water below freezing.", "type": "cooling"},
            {"goal": "Cool water until it becomes ice.", "type": "cooling"},
            {"goal": "Reduce the temperature of water.", "type": "cooling"},
            {"goal": "Cool a heated substance back to room temperature.", "type": "cooling"},
            {"goal": "Freeze water by cooling it.", "type": "cooling"},
            {"goal": "Lower the temperature of the beaker contents.", "type": "cooling"},
            {"goal": "Cool water and measure its temperature.", "type": "cooling"},
            {"goal": "Cool the water until it solidifies.", "type": "cooling"},
            {"goal": "Reduce water temperature below 0°C.", "type": "cooling"},
            {"goal": "Cool a sample and record the temperature change.", "type": "cooling"},
            {"goal": "Cool heated water back down.", "type": "cooling"},
            {"goal": "Chill water to near freezing.", "type": "cooling"},
            {"goal": "Cool the beaker contents significantly.", "type": "cooling"},
            {"goal": "Bring the water temperature down by cooling.", "type": "cooling"},
            {"goal": "Cool water from the sink below freezing.", "type": "cooling"},
            # --- Biology (10 tasks) ---
            {"goal": "Grow a plant from a seed.", "type": "biology"},
            {"goal": "Plant a seed in soil.", "type": "biology"},
            {"goal": "Observe the health of the plant.", "type": "biology"},
            {"goal": "Move the plant to the lab for observation.", "type": "biology"},
            {"goal": "Check on the plant in the greenhouse.", "type": "biology"},
            {"goal": "Examine the seed and plant it.", "type": "biology"},
            {"goal": "Water the plant in the greenhouse.", "type": "biology"},
            {"goal": "Place a seed in soil and water it.", "type": "biology"},
            {"goal": "Observe a growing plant.", "type": "biology"},
            {"goal": "Transplant the plant to a new location.", "type": "biology"},
            # --- Chemistry (10 tasks) ---
            {"goal": "Mix two substances together.", "type": "chemistry"},
            {"goal": "Combine water and soil.", "type": "chemistry"},
            {"goal": "Mix substances in a beaker.", "type": "chemistry"},
            {"goal": "Combine ice and water in a container.", "type": "chemistry"},
            {"goal": "Mix heated and cooled substances.", "type": "chemistry"},
            {"goal": "Pour water into a beaker with another substance.", "type": "chemistry"},
            {"goal": "Create a mixture in the lab.", "type": "chemistry"},
            {"goal": "Combine two items from your inventory.", "type": "chemistry"},
            {"goal": "Mix substances and observe the result.", "type": "chemistry"},
            {"goal": "Dissolve a substance in water.", "type": "chemistry"},
            # --- Observation (8 tasks) ---
            {"goal": "Observe the state change of ice.", "type": "observation"},
            {"goal": "Look around the lab and describe what you see.", "type": "observation"},
            {"goal": "Examine the objects in the greenhouse.", "type": "observation"},
            {"goal": "Observe what happens when water freezes.", "type": "observation"},
            {"goal": "Watch ice melt and describe the process.", "type": "observation"},
            {"goal": "Examine the contents of the storage room.", "type": "observation"},
            {"goal": "Observe the bunsen burner in the lab.", "type": "observation"},
            {"goal": "Look at the water in the sink.", "type": "observation"},
            # --- Experiment (7 tasks) ---
            {"goal": "Conduct a temperature experiment.", "type": "experiment"},
            {"goal": "Design an experiment to test melting points.", "type": "experiment"},
            {"goal": "Run an experiment comparing heating and cooling.", "type": "experiment"},
            {"goal": "Test what temperature water boils at.", "type": "experiment"},
            {"goal": "Experiment with phase changes of water.", "type": "experiment"},
            {"goal": "Set up and run a freezing experiment.", "type": "experiment"},
            {"goal": "Conduct an experiment on heat transfer.", "type": "experiment"},
        ]
